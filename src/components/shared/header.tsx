...
const Header = () => {
    ...
    return (
        <>
            <header className={`flex justify-between items-center px-4 md:px-8 py-3 sticky top-0 z-50 transition-all duration-300 ${
                scrolled 
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className={`hidden md:flex bg-gray-50 rounded-full border border-gray-200 transition-all duration-300 ${
                        searchFocused 
                        ...
                        <Popover>
                            ...
                            <PopoverContent className='w-56 p-0 shadow-lg border border-gray-200 rounded-xl overflow-hidden'>
                                ...
                                <div className='flex flex-col p-1'>
                                    ...
                                    <hr className='my-1' />
                                    <button className='flex items-center gap-3 hover:bg-gray-50 hover:text-blue-600 p-3 rounded-md transition-colors duration-200 text-sm'>
